...
wk.register({
	["["] = { "<cmd>bp<cr>", "Focus Left Buffer" },
	["]"] = { "<cmd>bn<cr>", "Focus Right Buffer" },
...
wk.register({
	...
	b = { "<cmd>Fern . -drawer -toggle<cr>", "Toggle File Tree" },
    d = { "<cmd>TroubleToggle document_diagnostics", "Toggle Document Diagnostics"},
	e = {
